...
import Build_Meels from "../Menu/How to Build you Meels/Build_Meels";
  ...
  const [menudata , setmenuData] = useState([]);
    ...
    return (
        <div className="dark:text-black">
             <h1 className="text-[30px] text-center mt-[30px]">Order Type : Take Away</h1>
...
<div className="mt-[20px] grid md:grid-cols-2 lg:grid-cols-3 gap-[20px] md:w-[95%] lg:w-[1080px]  mx-auto ">

    {
       ...
       <Link to={`/TAmenu/${item.id}`}><button className="text-white bgorg w-full rounded-[5px] flex gap-[5px] items-center justify-center py-[4px] mt-[10px]"><TbSettingsCog></TbSettingsCog> Customize & Order</button></Link>
